...
# Students were given a somewhat realistic schedule where they aimed to arrive at a
# certain time on a given day each week with a standard deviation of 300 seconds.
...
# Displaying signs randomly where the same slide could not be chosen two times in a row
